...
describe('SupplementalAspectCard', () => {
    it('renders the card with the correct title', () => {
        ...
        render(<SupplementalAspectCard id="1" parentId="section-1" title="Test Card" functionObjectIds={['objId1']}
    ...
    it('displays state objects sorted by rank and filtered by functionObjectIds', () => {
        ...
        render(<SupplementalAspectCard id="1" parentId="section-1" title="Test Card" functionObjectIds={['2', '1']}
                                       onAspectCardTitleClicked={() => {
                                       }}/>);
    ...
    it('does not display the card if there are no matching state objects', () => {
        ...
        const {container} = render(
            <SupplementalAspectCard id="1" parentId="section-1" title="Test Card" functionObjectIds={['1']}
                                    onAspectCardTitleClicked={() => {
                                    }}/>,
        );
