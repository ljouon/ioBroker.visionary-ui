    ...
    if ('boolean' === uiStateObject.datatype) {
        displayElement =
            uiStateObject.value === true ? (
                <DynamicMaterialDesignIcon iconKey="check-circle-outline" className="w-6 h-6 text-green-600" />
            ) : (
                <DynamicMaterialDesignIcon iconKey="close-circle-outline" className="w-6 h-6 text-red-600" />
            );
