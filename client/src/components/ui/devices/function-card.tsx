...
export function FunctionCard({id, title, roomId}: FunctionCardProps) {
            ...
            <CardHeader>
                <div className="flex items-center justify-between space-x-2">
                    <div><CardTitle>{title}</CardTitle>
                        {/*<CardDescription>Beschreibung!? Beschreibung!? Beschreibung!? Beschreibung!? Beschreibung!? </CardDescription>*/}
                    </div>
            ...
            <CardContent className="grid gap-6">
                ...
                <div className="flex justify-between items-center">
                    <div className="flex items-center space-x-2">
                        <img
                            className="dark:invert w-10 h-10 mr-2"
                            src={icon ?? undefined}
                            alt={'icon'}
                        />
                        <Label htmlFor={`${roomId}_${id}_object_id`} className="flex flex-col space-y-1">
